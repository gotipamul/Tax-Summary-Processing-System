                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="myprofileup.php?id=<?php echo $id?>" >
                        ...
                        <div class="input-group">
                         ...
                         <div class="input-group">
                          <p>Address</p>
                            <input class="input--style-1" type="text"  name="address" value="<?php echo $tot_tax_liability;?>" readonly>
                        </div>

                        <div class="input-group">
                          <p>Taxable income</p>
                            <input class="input--style-1" type="text" name="tax" value="<?php echo $tax;?>" readonly>
                        </div>

                        <div class="input-group">
                          <p>Income tax</p>
                            <input class="input--style-1" type="text" name="income_tax" value="<?php echo $income_tax;?>" readonly>
                        </div>
